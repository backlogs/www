...
The Backlogs plugin is supported on Redmine 1.3.0 or ChiliProject 2.6.0. Other versions are known to work but are not supported. For more information on Redmine and how to install it, please visit "the official Redmine website":http://www.redmine.org/ or "the official ChiliProject website":https://www.chiliproject.org/ .
