...
bq(info). See also an "alternative instruction":https://github.com/backlogs/redmine_backlogs/wiki/Installation-of-Backlogs-in-Redmine-2.0
...
The Backlogs plugin is supported on Redmine 2.0.4, 2.1.6 or 2.2.1. Other versions are known to work but are not supported. For more information on Redmine and how to install it, please visit "the official Redmine website":http://www.redmine.org/ or "the official ChiliProject website":https://www.chiliproject.org/ .
