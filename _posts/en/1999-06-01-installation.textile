...
The Backlogs plugin requires Redmine 1.2.0 to be installed; 1.1.x is known to work but is not supported. Anything lower will not work, period. For more information on Redmine and how to install it, please visit "the official Redmine website":http://www.redmine.org/.
