...
The Backlogs plugin requires Redmine 1.3.x to be installed. 1.2.x is
known to work but is not supported. For more information on Redmine and how to install it, please visit "the official Redmine website":http://www.redmine.org/.
